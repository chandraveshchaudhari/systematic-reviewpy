...
setuptools.setup(
    ...
    name='systematic-reviewpy-CHANDRAVESH-CHAUDHARI',  # Required
    ...
    url="https://github.com/chandraveshchaudhari/systematic-reviewpy",  # Optional
    ...
    #
    # Note that this is a list of additional unique_preprocessed_clean_grouped_keywords_dict, separated
    # by commas, to be used to assist searching for the distribution in a
    # larger catalog.
    keywords='browser, automation, systematic review, research papers, Bibliometric analysis ',  # Optional
    ...
    project_urls={  # Optional
        "Bug Tracker": "https://github.com/chandraveshchaudhari/systematic-reviewpy/issues",
        'Bug Reports': 'https://github.com/chandraveshchaudhari/systematic-reviewpy/issues',
