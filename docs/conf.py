...
# extensions coming with Sphinx (named 'sphinx.ext.*') or your custom_text_manipulation_function
# ones.
...
# Add any paths that contain custom_text_manipulation_function static files (such as style sheets) here,
